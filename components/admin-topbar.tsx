  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
      <div className="flex items-center gap-x-3 px-4 sm:px-6 h-14">
        ...
        {/* ── Breadcrumbs ── */}
        <nav aria-label="Breadcrumb" className="hidden sm:flex items-center gap-x-1 text-sm">
          {crumbs.map((crumb, idx) => {
            const isLast = idx === crumbs.length - 1;
            return (
              <span key={crumb.href} className="flex items-center gap-x-1">
                {idx > 0 && (
                  <svg className="size-3.5 text-gray-400 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* ── Notifications ── */}
        <div className="hs-dropdown relative" data-hs-dropdown-placement="bottom-right">
          <button
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-neutral-700">
              <h3 className="text-sm font-semibold text-gray-800 dark:text-neutral-200">Notifications</h3>
            ...
            <ul className="divide-y divide-gray-100 dark:divide-neutral-700 max-h-72 overflow-y-auto">
              {[
                ...
                { title: "Server usage at 90%", time: "1 hr ago", unread: true },
                { title: "New user registered", time: "3 hrs ago", unread: false },
              ].map((n) => (
                <li key={n.title}>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <div>
                      <p className={`text-sm ${n.unread ? "font-medium text-gray-800 dark:text-neutral-200" : "text-gray-600 dark:text-neutral-400"}`}>
                        {n.title}
                      </p>
                      <p className="text-xs text-gray-400 dark:text-neutral-500 mt-0.5">{n.time}</p>
                    </div>
                  </button>
                </li>
              ))}
        ...
        <div className="hs-dropdown relative" data-hs-dropdown-placement="bottom-right">
          ...
          >
            ...
            <svg className="size-4 text-gray-400 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          >
            <div className="px-3 py-2 border-b border-gray-200 dark:border-neutral-700 mb-1">
              <p className="text-sm font-semibold text-gray-800 dark:text-neutral-200">default</p>
              <p className="text-xs text-gray-500 dark:text-neutral-400">default@example.com</p>
            </div>
