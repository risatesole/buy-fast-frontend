  ...
  return (
    <main className="min-h-screen bg-[#f7f9fb] px-4 py-10">
      <section className="mx-auto max-w-6xl">
        <h1 className="mb-8 font-serif text-3xl font-bold text-[#002d62]">Carrito de compra</h1>
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
            <section className="rounded-lg border border-gray-200 bg-white">
              <div className="border-b border-gray-200 px-6 py-4">
                <h2 className="font-serif text-xl font-bold text-[#002d62]">Productos</h2>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center">
                        <h3 className="font-semibold uppercase text-[#191c1e]">{itemName}</h3>
                      ...
                      <div className="col-span-2 flex items-center justify-between border-t border-gray-100 pt-4 md:col-span-1 md:border-t-0 md:pt-0">
                        ...
                        <span className="font-bold text-[#002d62]">{formatCurrency(total)}</span>
                      </div>
                    </article>
                  );
                })}
            ...
            <aside className="h-fit rounded-lg border border-gray-200 bg-white p-6">
              ...
              <div className="mt-5 flex items-center justify-between">
                <span className="font-serif text-lg font-bold text-[#191c1e]">Total</span>
